 ...
 */
export const createMinimalOpusTagsPage = (serialNumber, pageSequence) => {
 ...
 */
export const createOpusHeadPage = (serialNumber, channels = 2, preskip = 312, // Standard Opus pre-skip
sampleRate = 48000) => {
 ...
 */
const calculateOpusGranule = (packetIndex, samplesPerPacket = 960) => {
    return BigInt((packetIndex + 1) * samplesPerPacket);
};
/**
 * Wrap raw Opus packets into a complete Ogg Opus file
 */
export const wrapOpusPacketsInOgg = (packets, options) => {
